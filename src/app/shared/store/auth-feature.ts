// This file defines the Auth slice of NgRx state, how it starts, how it changes in response to actions, and how the rest of the app reads authentication status safely and efficiently.
